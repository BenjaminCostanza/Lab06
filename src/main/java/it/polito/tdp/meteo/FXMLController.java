...
public class FXMLController {
    ...
    void doCalcolaUmidita(ActionEvent event) {
        ...
        for(RilevamentoMedio r : rilevamentiMedi) {
        	//In questi casi usare appendText e non setText poichè permette di concatenare il testo mentre il set va a sostituirlo
    ...
    void initialize() {
        ...
        for(int mese=1; mese<=12;mese++) { //Popolo la ChoiceBox
